...
function scoreboard(inningcb, getInningScoreCb, inningstobeplayed) {
  const scoreTracker = [];
  let homeScore = 0;
  let awayScore = 0;
  ...
  } else scoreTracker.push(`Final Score: Away ${awayScore} - Home ${homeScore}`);
  return scoreTracker;
  }

console.log('Task5',scoreboard(inning,getInningScore,9));
